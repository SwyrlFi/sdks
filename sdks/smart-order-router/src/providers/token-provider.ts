...
export const WBTC_SONIC = new Token(
  ChainId.SONIC,
...
export const WETH_SONIC = new Token(
  ChainId.SONIC,
...
export const WMON_MONAD_TESTNET = new Token(
...
export const USDC_MONAD_DEVNET = new Token(
  ChainId.MONAD_DEVNET,
  '0xafc79c3ddf82b6814a5835cc6e7689c2887db73d',
  6,
  'USDC',
  'USD Coin'
);
