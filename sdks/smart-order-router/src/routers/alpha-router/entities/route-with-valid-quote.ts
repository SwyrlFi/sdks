...
export type V2RouteWithValidQuoteParams = {
  ...
  percent: number;
  route: V2Route;
  gasModel: IGasModel<V2RouteWithValidQuote> | undefined;
  quoteToken: Token;
  tradeType: TradeType;
...
export class V2RouteWithValidQuote implements IV2RouteWithValidQuote {
  ...
  public gasModel: IGasModel<V2RouteWithValidQuote> | undefined;
...
export type V3RouteWithValidQuoteParams = {
  ...
  percent: number;
  route: V3Route;
  gasModel: IGasModel<V3RouteWithValidQuote> | undefined;
  quoteToken: Token;
  tradeType: TradeType;
...
export class V3RouteWithValidQuote implements IV3RouteWithValidQuote {
  ...
  public quoteToken: Token;
  public gasModel: IGasModel<V3RouteWithValidQuote> | undefined;
  public gasEstimate: BigNumber;
  public gasCostInToken: CurrencyAmount;
  public gasCostInUSD: CurrencyAmount;
  public tradeType: TradeType;
...
export type MixedRouteWithValidQuoteParams = {
  ...
  percent: number;
  route: MixedRoute;
  mixedRouteGasModel: IGasModel<MixedRouteWithValidQuote> | undefined;
  quoteToken: Token;
  tradeType: TradeType;
  v3PoolProvider: IV3PoolProvider;
  v2PoolProvider: IV2PoolProvider;
...
export class MixedRouteWithValidQuote implements IMixedRouteWithValidQuote {
  ...
  public quoteToken: Token;
  public gasModel: IGasModel<MixedRouteWithValidQuote> | undefined;
  public gasEstimate: BigNumber;
  public gasCostInToken: CurrencyAmount;
  public gasCostInUSD: CurrencyAmount;
  public tradeType: TradeType;
