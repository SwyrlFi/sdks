    ...
    ISwapToRatio<AlphaRouterConfig, SwapAndAddConfig>
{
  ...
  private async getSwapRouteFromCache(
    ...
    v3GasModel: IGasModel<V3RouteWithValidQuote> | undefined,
  ...
  private async getSwapRouteFromChain(
    ...
    const mixedProtocolAllowed =
      [ChainId.MAINNET, ChainId.GÖRLI, ChainId.SONIC, ChainId.MONAD_TESTNET, ChainId.MONAD_DEVNET].includes(this.chainId) &&
