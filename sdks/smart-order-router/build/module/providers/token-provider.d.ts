...
export declare const USDT_SONIC: Token;
export declare const WBTC_SONIC: Token;
export declare const WETH_SONIC: Token;
export declare const WMON_MONAD_TESTNET: Token;
export declare const USDC_MONAD_TESTNET: Token;
export declare const USDC_MONAD_DEVNET: Token;
